...
function SelectValue<T extends object>({
  ...
  return (
    <SelectValuePrimitive
      ...
      className={cn(
        "flex min-w-0 flex-1 overflow-hidden text-left text-ellipsis whitespace-nowrap data-placeholder:text-muted-foreground",
        className
      )}
      {...props}
    >
...
function SelectList<T extends object>({
  ...
  return (
    <ListBoxPrimitive
      ...
      className={cn(
        "group/select-list min-h-0 flex-1 overflow-x-hidden overflow-y-auto p-0 outline-hidden",
        className
      )}
      {...props}
    />
...
function SelectInput({
  ...
  return (
    <SearchField
      ...
      className={cn("shrink-0 border-b border-border bg-popover p-2", className)}
    >
      <InputGroup>
        <InputGroupInput
